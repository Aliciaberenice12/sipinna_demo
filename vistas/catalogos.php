...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../lib/swetalert/sweetalert2.min.css" />
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <button type="button" class="btn btn-catalogo  hint--bottom" aria-label="Catalogo Derechos" name="tbl_derechos" id="tbl_derechos" onclick="mostrar_tablas(4);">
                    Catálogo Derechos Vulnerados
                </button>
                <div><br></div>
    ...
    <!--Modal Derechos-->
    <div class="modal fade" id="mod_cat_derechos" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-secondary">
                    <h5 class="modal-title" id="tit_mod_derechos" style="color:white"></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="id_der_cat" id="id_der_cat" value="0">
                    <div class="row">
                        <div class="col-12 mt-2">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="derecho" value="" id="derecho" placeholder="derecho *" maxlength="100">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn_d" class="btn btn-dark" onclick="fn_guardar_derecho();">Guardar</button>
                </div>
            </div>
        </div>
    </div>
