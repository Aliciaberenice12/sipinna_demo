...
-- Volcando datos para la tabla sipinna.cat_estados: ~34 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `tbl_c4_desc_casos` (
  ...
  `c4_observaciones` varchar(250) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_can_casos_reportados` (
  ...
  `expediente_id_caso` int(11) DEFAULT NULL,
  `can_update_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_can_expediente` (
  ...
  `can_ruta_sol_oficio` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_can_solicitante` (
  ...
  `can_inst_solicitante` varchar(50) DEFAULT NULL,
...
-- Volcando datos para la tabla sipinna.usuarios: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellidos`, `departamento`, `usuario`, `email`, `contrasena`, `imagen`, `estado`, `perfil`) VALUES
	(265, 'admin', 'admin', 'admin', 'admin', 'admin', '$2a$07$125Rdvlaptdf98112dsrqe6OQLyNre0JieQ4jGKy4eyouqwSdw99m', '874288745.jpg', 1, 1),
	(266, 'alicia 2', 'cortes 2', 'Sistemas 2', 'alicia12', 'berenicee.co2rtes69@gmail.com', '$2a$07$125Rdvlaptdf98112dsrqeaAzAkR8Gejk6eOHN35IPVrl5OQfoGru', '2141620334.jpg', 1, 0);
